// This is a literal copy from: https://github.com/t3-oss/create-t3-app/blob/e95e3adff11b91fee1de0021cbb858be604b80d4/cli/src/helpers/git.ts
...
export const isRootGitRepo = async (dir: string): Promise<boolean> => {
